...
export default function Hero({ setHovered }) {
    ...
    return (
        <div style={{
            ...
            {/* ✅ Yahan — return ke andar, sabse pehle */}
            ...
            <div style={{
                ...
                <div
                    ...
                    style={{
                        ...
                        fontSize: "clamp(4rem, 9vw, 9rem)", letterSpacing: "0.05em",
                        marginBottom: "2.5rem", cursor: "none",
                    }}>HEY, I'M</div>
                ...
                <div
                    ...
                    style={{
                        ...
                        cursor: "none", userSelect: "none", minWidth: "2ch",
